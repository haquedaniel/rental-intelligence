...
BACKUP_DIR="$ROOT/.pilotys-backups/cleaner-correspondence-owner-note-v1-$STAMP"
...
# Show owner note immediately after opening main if the variable is named request.
...
echo "Installed cleaner correspondence + owner note v1"
