# Pilotys owner cockpit v11

This package fixes the v8 placement mistake.

The deployed Next.js app is `apps/cleaner-web`, so v11 installs the token owner cockpit into:
...
```bash
bash /path/to/pilotys-owner-token-cockpit-v11/scripts/install-v11-cleaner-web.sh
