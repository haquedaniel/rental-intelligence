...
function OwnerForm({
  ...
  return (
    <form action={saveOwner} encType="multipart/form-data" className="rounded-[2rem] bg-white/92 p-5 shadow-sm ring-1 ring-[#112532]/8">
      ...
      {!isNew && owner.public_token && (
        <div className="mt-4 rounded-2xl bg-[#F6F3EF] p-4 ring-1 ring-slate-100">
          ...
          <Link
            ...
            className="mt-2 block break-all rounded-xl bg-white p-3 text-sm font-bold text-[#112532] ring-1 ring-[#112532]/10"
          >
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Nom affiché</span>
          <input
            name="display_name"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Nom légal / facturation</span>
          <input
            name="legal_name"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Email facturation</span>
          <input
            name="billing_email"
            type="email"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Téléphone</span>
          <input
            name="phone"
        ...
        <label className="block md:col-span-2">
          <span className="text-sm font-semibold text-[#112532]/86">Adresse de facturation</span>
          <textarea
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">SIREN</span>
          <input
            name="siren"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">SIRET</span>
          <input
            name="siret"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">N° TVA</span>
          <input
            name="vat_number"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Statut TVA</span>
          <input
            name="vat_status"
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Plateforme e-facturation</span>
          <input
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Délai paiement</span>
          <input
        ...
        <label className="block">
          <span className="text-sm font-semibold text-[#112532]/86">Canal demande paiement</span>
          <select
        ...
        <label className="block md:col-span-2">
          <span className="text-sm font-semibold text-[#112532]/86">Notes internes</span>
          <textarea
            name="notes"
      ...
      <section className="mt-5 rounded-2xl bg-[#F6F3EF] p-4">
        <h3 className="font-bold text-[#112532]">Biens liés</h3>
          ...
          {properties.map((property) => {
            ...
            return (
              ...
              >
                ...
                <span>
                  <span className="font-bold text-[#112532]/86">
                  ...
                  {!property.owner_id && (
                    <span className="mt-1 block text-xs text-[#112532]/48">
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        <button className="rounded-full bg-[#112532] px-5 py-3 text-sm font-bold text-white">
