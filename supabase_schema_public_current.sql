...
CREATE TABLE IF NOT EXISTS "public"."cleaning_requests" (
    ...
    "owner_note" "text",
    "cleaner_priority_note" "text",
    "owner_note_updated_at" timestamp with time zone,
    "owner_note_updated_by" "text",
    "prepares_reservation_id" "uuid",
    "prepares_reservation_linked_at" timestamp with time zone,
    "prepares_reservation_linked_by" "text",
...
CREATE OR REPLACE VIEW "public"."ops_current_alerts" AS
 WITH "duplicate_active_missions" AS (
         SELECT "cleaning_requests"."reservation_id",
            "count"(*) AS "active_request_count"
           FROM "public"."cleaning_requests"
          WHERE (("cleaning_requests"."reservation_id" IS NOT NULL) AND (COALESCE("cleaning_requests"."status", ''::"text") <> ALL (ARRAY['cancelled'::"text", 'refused'::"text", 'completed'::"text", 'report_submitted'::"text", 'problem_reported'::"text"])))
          GROUP BY "cleaning_requests"."reservation_id"
         HAVING ("count"(*) > 1)
        )
 SELECT "now"() AS "checked_at",
    'event_warning'::"text" AS "alert_type",
    "operational_event_log"."severity",
    "operational_event_log"."property_id",
    "operational_event_log"."reservation_id",
    "operational_event_log"."cleaning_request_id",
    "operational_event_log"."cleaner_id",
    "operational_event_log"."title",
    "operational_event_log"."summary",
    "operational_event_log"."reason_code",
    "operational_event_log"."created_at",
    "operational_event_log"."context"
   FROM "public"."operational_event_log"
  WHERE (("operational_event_log"."severity" = ANY (ARRAY['warning'::"text", 'error'::"text", 'critical'::"text"])) AND ("operational_event_log"."created_at" > ("now"() - '48:00:00'::interval)))
UNION ALL
 SELECT "now"() AS "checked_at",
    'old_pending_message'::"text" AS "alert_type",
    'warning'::"text" AS "severity",
    NULL::"text" AS "property_id",
    NULL::"text" AS "reservation_id",
    ("outbound_messages"."cleaning_request_id")::"text" AS "cleaning_request_id",
    ("outbound_messages"."cleaner_id")::"text" AS "cleaner_id",
    'Message SMS en attente'::"text" AS "title",
    "left"(COALESCE("outbound_messages"."body", ''::"text"), 220) AS "summary",
    "outbound_messages"."status" AS "reason_code",
    "outbound_messages"."created_at",
    "jsonb_build_object"('message_type', "outbound_messages"."message_type", 'channel', "outbound_messages"."channel", 'recipient_phone', "outbound_messages"."recipient_phone", 'provider', "outbound_messages"."provider", 'event_key', "outbound_messages"."event_key") AS "context"
   FROM "public"."outbound_messages"
  WHERE (("outbound_messages"."status" = 'pending'::"text") AND ("outbound_messages"."created_at" < ("now"() - '00:15:00'::interval)))
UNION ALL
 SELECT "now"() AS "checked_at",
    'failed_message'::"text" AS "alert_type",
    'warning'::"text" AS "severity",
    NULL::"text" AS "property_id",
    NULL::"text" AS "reservation_id",
    ("outbound_messages"."cleaning_request_id")::"text" AS "cleaning_request_id",
    ("outbound_messages"."cleaner_id")::"text" AS "cleaner_id",
    'Message sortant échoué'::"text" AS "title",
    "left"(COALESCE("outbound_messages"."body", ''::"text"), 220) AS "summary",
    "outbound_messages"."status" AS "reason_code",
    "outbound_messages"."created_at",
    "jsonb_build_object"('message_type', "outbound_messages"."message_type", 'channel', "outbound_messages"."channel", 'recipient_phone', "outbound_messages"."recipient_phone", 'provider', "outbound_messages"."provider", 'event_key', "outbound_messages"."event_key") AS "context"
   FROM "public"."outbound_messages"
  WHERE (("outbound_messages"."status" = ANY (ARRAY['failed'::"text", 'error'::"text"])) AND ("outbound_messages"."created_at" > ("now"() - '48:00:00'::interval)))
UNION ALL
 SELECT "now"() AS "checked_at",
    'mission_without_cleaner'::"text" AS "alert_type",
    'critical'::"text" AS "severity",
    ("cleaning_requests"."property_id")::"text" AS "property_id",
    ("cleaning_requests"."reservation_id")::"text" AS "reservation_id",
    ("cleaning_requests"."id")::"text" AS "cleaning_request_id",
    NULL::"text" AS "cleaner_id",
    'Mission sans intervenant'::"text" AS "title",
    COALESCE("cleaning_requests"."title", 'Mission active sans intervenant assigné'::"text") AS "summary",
    "cleaning_requests"."status" AS "reason_code",
    "cleaning_requests"."created_at",
    "jsonb_build_object"('status', "cleaning_requests"."status", 'schedule_status', "cleaning_requests"."schedule_status", 'completion_deadline_at', "cleaning_requests"."completion_deadline_at") AS "context"
   FROM "public"."cleaning_requests"
  WHERE (("cleaning_requests"."assigned_cleaner_id" IS NULL) AND (COALESCE("cleaning_requests"."status", ''::"text") <> ALL (ARRAY['cancelled'::"text", 'refused'::"text", 'completed'::"text", 'report_submitted'::"text", 'problem_reported'::"text"])))
UNION ALL
 SELECT "now"() AS "checked_at",
    'accepted_mission_overdue'::"text" AS "alert_type",
    'warning'::"text" AS "severity",
    ("cleaning_requests"."property_id")::"text" AS "property_id",
    ("cleaning_requests"."reservation_id")::"text" AS "reservation_id",
    ("cleaning_requests"."id")::"text" AS "cleaning_request_id",
    ("cleaning_requests"."assigned_cleaner_id")::"text" AS "cleaner_id",
    'Mission acceptée en retard'::"text" AS "title",
    COALESCE("cleaning_requests"."title", 'Mission acceptée mais échéance dépassée'::"text") AS "summary",
    "cleaning_requests"."status" AS "reason_code",
    "cleaning_requests"."created_at",
    "jsonb_build_object"('ready_by_at', "cleaning_requests"."ready_by_at", 'completion_deadline_at', "cleaning_requests"."completion_deadline_at", 'scheduled_end_at', "cleaning_requests"."scheduled_end_at") AS "context"
   FROM "public"."cleaning_requests"
  WHERE (("cleaning_requests"."status" = 'accepted'::"text") AND (COALESCE("cleaning_requests"."ready_by_at", "cleaning_requests"."completion_deadline_at", "cleaning_requests"."scheduled_end_at") < "now"()))
UNION ALL
 SELECT "now"() AS "checked_at",
    'duplicate_active_missions'::"text" AS "alert_type",
    'critical'::"text" AS "severity",
    ("cr"."property_id")::"text" AS "property_id",
    ("cr"."reservation_id")::"text" AS "reservation_id",
    ("cr"."id")::"text" AS "cleaning_request_id",
    ("cr"."assigned_cleaner_id")::"text" AS "cleaner_id",
    'Plusieurs missions actives pour une réservation'::"text" AS "title",
    'Une même réservation a plusieurs missions actives.'::"text" AS "summary",
    "cr"."status" AS "reason_code",
    "cr"."created_at",
    "jsonb_build_object"('active_request_count', "d"."active_request_count", 'schedule_status', "cr"."schedule_status") AS "context"
   FROM ("public"."cleaning_requests" "cr"
     JOIN "duplicate_active_missions" "d" ON (("d"."reservation_id" = "cr"."reservation_id")))
  WHERE (COALESCE("cr"."status", ''::"text") <> ALL (ARRAY['cancelled'::"text", 'refused'::"text", 'completed'::"text", 'report_submitted'::"text", 'problem_reported'::"text"]));


ALTER VIEW "public"."ops_current_alerts" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."ops_health_summary" AS
 SELECT "now"() AS "checked_at",
    ( SELECT "max"("operational_event_log"."created_at") AS "max"
           FROM "public"."operational_event_log") AS "last_operational_event_at",
    ( SELECT "count"(*) AS "count"
           FROM "public"."operational_event_log"
          WHERE (("operational_event_log"."severity" = ANY (ARRAY['warning'::"text", 'error'::"text", 'critical'::"text"])) AND ("operational_event_log"."created_at" > ("now"() - '24:00:00'::interval)))) AS "warning_events_24h",
    ( SELECT "count"(*) AS "count"
           FROM "public"."operational_event_log"
          WHERE (("operational_event_log"."severity" = ANY (ARRAY['error'::"text", 'critical'::"text"])) AND ("operational_event_log"."created_at" > ("now"() - '24:00:00'::interval)))) AS "critical_events_24h",
    ( SELECT "count"(*) AS "count"
           FROM "public"."outbound_messages"
          WHERE ("outbound_messages"."status" = 'pending'::"text")) AS "pending_messages",
    ( SELECT "count"(*) AS "count"
           FROM "public"."outbound_messages"
          WHERE (("outbound_messages"."status" = 'pending'::"text") AND ("outbound_messages"."created_at" < ("now"() - '00:15:00'::interval)))) AS "old_pending_messages",
    ( SELECT "count"(*) AS "count"
           FROM "public"."outbound_messages"
          WHERE (("outbound_messages"."status" = ANY (ARRAY['failed'::"text", 'error'::"text"])) AND ("outbound_messages"."created_at" > ("now"() - '24:00:00'::interval)))) AS "failed_messages_24h",
    ( SELECT "count"(*) AS "count"
           FROM "public"."ops_current_alerts"
          WHERE ("ops_current_alerts"."severity" = 'critical'::"text")) AS "current_critical_alerts",
    ( SELECT "count"(*) AS "count"
           FROM "public"."ops_current_alerts"
          WHERE ("ops_current_alerts"."severity" = 'warning'::"text")) AS "current_warning_alerts",
        CASE
            WHEN (( SELECT "count"(*) AS "count"
               FROM "public"."ops_current_alerts"
              WHERE ("ops_current_alerts"."severity" = 'critical'::"text")) > 0) THEN 'critical'::"text"
            WHEN (( SELECT "count"(*) AS "count"
               FROM "public"."ops_current_alerts"
              WHERE ("ops_current_alerts"."severity" = 'warning'::"text")) > 0) THEN 'warning'::"text"
            ELSE 'ok'::"text"
        END AS "health_status";


ALTER VIEW "public"."ops_health_summary" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."ops_recent_activity" AS
 SELECT "operational_event_log"."created_at",
    "operational_event_log"."source",
    "operational_event_log"."event_type",
    "operational_event_log"."severity",
    "operational_event_log"."property_id",
    "operational_event_log"."reservation_id",
    "operational_event_log"."cleaning_request_id",
    ...
    "operational_event_log"."summary",
    "operational_event_log"."reason_code",
    "operational_event_log"."reason",
    "operational_event_log"."context"
   FROM "public"."operational_event_log"
UNION ALL
 SELECT "om"."created_at",
    'outbound_messages'::"text" AS "source",
    "om"."message_type" AS "event_type",
        CASE
            WHEN ("om"."status" = ANY (ARRAY['failed'::"text", 'error'::"text"])) THEN 'warning'::"text"
            WHEN (("om"."status" = 'pending'::"text") AND ("om"."created_at" < ("now"() - '00:15:00'::interval))) THEN 'warning'::"text"
            ELSE 'info'::"text"
        END AS "severity",
    ("cr"."property_id")::"text" AS "property_id",
    ("cr"."reservation_id")::"text" AS "reservation_id",
    ("om"."cleaning_request_id")::"text" AS "cleaning_request_id",
    COALESCE(("om"."cleaner_id")::"text", ("cr"."assigned_cleaner_id")::"text") AS "cleaner_id",
    'Message sortant'::"text" AS "title",
    "left"(COALESCE("om"."body", ''::"text"), 220) AS "summary",
    "om"."status" AS "reason_code",
    NULL::"text" AS "reason",
    "jsonb_build_object"('channel', "om"."channel", 'status', "om"."status", 'provider', "om"."provider", 'recipient_phone', "om"."recipient_phone", 'event_key', "om"."event_key", 'message_type', "om"."message_type") AS "context"
   FROM ("public"."outbound_messages" "om"
     LEFT JOIN "public"."cleaning_requests" "cr" ON (("cr"."id" = "om"."cleaning_request_id")));


ALTER VIEW "public"."ops_recent_activity" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."ops_script_health" AS
 WITH "expected"("job_name", "max_age", "stale_severity") AS (
         VALUES ('ops_refresh'::"text",'00:30:00'::interval,'critical'::"text"), ('cockpit_refresh'::"text",'02:00:00'::interval,'warning'::"text"), ('market_refresh'::"text",'36:00:00'::interval,'warning'::"text"), ('cleaning_sms_cron'::"text",'00:30:00'::interval,'critical'::"text"), ('payment_sms_cron'::"text",'02:00:00'::interval,'warning'::"text")
        ), "latest" AS (
         SELECT DISTINCT ON ("operational_event_log"."job_name") "operational_event_log"."job_name",
            "operational_event_log"."created_at" AS "last_event_at",
            "operational_event_log"."event_type" AS "last_event_type",
            "operational_event_log"."severity" AS "last_severity",
            "operational_event_log"."title",
            "operational_event_log"."summary",
            "operational_event_log"."reason_code",
            "operational_event_log"."run_id"
           FROM "public"."operational_event_log"
          WHERE (("operational_event_log"."source" = 'cron_script'::"text") AND ("operational_event_log"."job_name" IS NOT NULL))
          ORDER BY "operational_event_log"."job_name", "operational_event_log"."created_at" DESC
        )
 SELECT "now"() AS "checked_at",
    "e"."job_name",
    "e"."max_age",
    ...
    "l"."run_id",
        CASE
            WHEN ("l"."last_event_at" IS NULL) THEN 'critical'::"text"
            WHEN ("l"."last_event_type" ~~ '%_failed'::"text") THEN 'critical'::"text"
            WHEN ("l"."last_event_at" < ("now"() - "e"."max_age")) THEN "e"."stale_severity"
            WHEN ("l"."last_event_type" ~~ '%_step_failed'::"text") THEN 'warning'::"text"
            ELSE 'ok'::"text"
        END AS "health_status"
   FROM ("expected" "e"
...
ALTER VIEW "public"."ops_script_health" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."owner_insight_messages" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "owner_id" "uuid",
    "property_id" "uuid",
    "reservation_id" "uuid",
    ...
    "message_type" "text" DEFAULT 'operational'::"text" NOT NULL,
    "severity" "text" DEFAULT 'info'::"text" NOT NULL,
...
ALTER TABLE "public"."owner_insight_messages" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_actions" (
    ...
    "floor_price_eur" numeric,
    "current_min_stay" integer,
    "recommended_min_stay" integer,
    "discount_pct" numeric,
    "reason_code" "text",
    "reason" "text",
    "beds24_payload" "jsonb",
    "beds24_response" "jsonb",
    "validation_before" "jsonb",
    "validation_after" "jsonb",
    "applied_at" timestamp with time zone,
    "error" "text",
    CONSTRAINT "pricing_actions_action_type_check" CHECK (("action_type" = ANY (ARRAY['price_change'::"text", 'min_stay_change'::"text", 'price_and_min_stay_change'::"text"]))),
    CONSTRAINT "pricing_actions_mode_check" CHECK (("mode" = ANY (ARRAY['shadow'::"text", 'apply'::"text"]))),
    CONSTRAINT "pricing_actions_status_check" CHECK (("status" = ANY (ARRAY['proposed'::"text", 'approved'::"text", 'applied'::"text", 'skipped'::"text", 'failed'::"text", 'validation_failed'::"text", 'cancelled'::"text"])))
);


ALTER TABLE "public"."pricing_actions" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pricing_autopilot_config" (
    "listing_id" "text" NOT NULL,
    "enabled" boolean DEFAULT false NOT NULL,
    "active_from" "date",
    "active_to" "date",
    "max_discount_pct" numeric DEFAULT 20 NOT NULL,
    "max_daily_change_pct" numeric DEFAULT 10 NOT NULL,
    "min_days_before_arrival" integer DEFAULT 1 NOT NULL,
    "max_days_before_arrival" integer DEFAULT 45 NOT NULL,
    "allow_min_stay_changes" boolean DEFAULT false NOT NULL,
    "require_post_write_validation" boolean DEFAULT true NOT NULL,
    "mode" "text" DEFAULT 'shadow'::"text" NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "note" "text",
    CONSTRAINT "pricing_autopilot_config_mode_check" CHECK (("mode" = ANY (ARRAY['shadow'::"text", 'apply'::"text"])))
);


ALTER TABLE "public"."pricing_autopilot_config" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_calendar_versions" (
    ...
    "changed_dates" integer DEFAULT 0 NOT NULL,
    "summary" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "pricing_calendar_versions_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'superseded'::"text"])))
);


ALTER TABLE "public"."pricing_calendar_versions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_configuration_versions" (
    ...
    "seasons_snapshot" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "change_summary" "text",
    "created_by" "text",
    "rolled_back_from_version_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "pricing_configuration_versions_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'superseded'::"text"])))
);


ALTER TABLE "public"."pricing_configuration_versions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_daily_prices" (
    ...
    "strategy_adjustment" numeric(10,2) DEFAULT 0 NOT NULL,
    "final_price" numeric(10,2) NOT NULL,
    "floor_price" numeric(10,2) NOT NULL,
    "ceiling_price" numeric(10,2),
    "min_stay" integer DEFAULT 2 NOT NULL,
    "strategy" "text" DEFAULT 'base_plan'::"text" NOT NULL,
    "decay_step" integer DEFAULT 0 NOT NULL,
    "gap_length" integer,
    ...
    "publication_status" "text" DEFAULT 'pending'::"text" NOT NULL,
    "configuration_version_id" "uuid",
    "calendar_version_id" "uuid",
    "explanation_steps" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "market_signal_pct" numeric(8,4) DEFAULT 0 NOT NULL,
    "time_discount_pct" numeric(8,4) DEFAULT 0 NOT NULL,
    CONSTRAINT "pricing_daily_prices_publication_status_check" CHECK (("publication_status" = ANY (ARRAY['pending'::"text", 'published'::"text", 'failed'::"text", 'not_required'::"text"])))
);


ALTER TABLE "public"."pricing_daily_prices" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_date_overrides" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "pricing_date_overrides_check" CHECK (("end_date" >= "start_date")),
    CONSTRAINT "pricing_date_overrides_min_stay_check" CHECK ((("min_stay" IS NULL) OR ("min_stay" >= 1)))
);


ALTER TABLE "public"."pricing_date_overrides" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pricing_floor_rules" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "listing_id" "text" NOT NULL,
...
ALTER TABLE "public"."pricing_floor_rules" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_property_settings" (
    ...
    "default_price" numeric(10,2) DEFAULT 100 NOT NULL,
    "default_weekend_price" numeric(10,2),
    "floor_price" numeric(10,2) DEFAULT 50 NOT NULL,
    "ceiling_price" numeric(10,2),
    "default_min_stay" integer DEFAULT 2 NOT NULL,
    "weekly_decay_amount" numeric(10,2) DEFAULT 2 NOT NULL,
    "weekly_decay_max_steps" integer DEFAULT 5 NOT NULL,
    "decay_starts_days_before_arrival" integer DEFAULT 120 NOT NULL,
    "one_night_gap_multiplier" numeric(8,4) DEFAULT 1.5 NOT NULL,
    "one_night_release_days" integer DEFAULT 21 NOT NULL,
    "protect_weekends" boolean DEFAULT true NOT NULL,
    "planning_horizon_days" integer DEFAULT 540 NOT NULL,
    "strategy_started_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "optimisation_curve" "jsonb" DEFAULT '[{"days_before": 120, "discount_pct": 0}, {"days_before": 90, "discount_pct": 2}, {"days_before": 60, "discount_pct": 6}, {"days_before": 30, "discount_pct": 15}, {"days_before": 7, "discount_pct": 25}, {"days_before": 0, "discount_pct": 30}]'::"jsonb" NOT NULL,
    "market_signal_enabled" boolean DEFAULT false NOT NULL,
    "market_signal_influence_pct" numeric(6,2) DEFAULT 0 NOT NULL,
    "market_signal_competitor_id" "text" DEFAULT 'le_goyen_hotel'::"text" NOT NULL,
    "optimisation_preset" "text" DEFAULT 'progressive'::"text" NOT NULL,
    "optimisation_horizon_days" integer DEFAULT 120 NOT NULL,
    "optimisation_max_discount_pct" numeric(6,2) DEFAULT 30 NOT NULL,
    "publication_paused" boolean DEFAULT false NOT NULL,
    "publication_last_run_at" timestamp with time zone,
    "publication_last_success_at" timestamp with time zone,
    "publication_last_error" "text",
    "publication_price_increment" numeric(10,2) DEFAULT 1.00 NOT NULL,
    "publication_min_change_eur" numeric(10,2) DEFAULT 1.00 NOT NULL,
    "publication_last_selected" integer DEFAULT 0 NOT NULL,
    "publication_last_applied" integer DEFAULT 0 NOT NULL,
    "publication_last_failed" integer DEFAULT 0 NOT NULL,
    "publication_last_reconciled" integer DEFAULT 0 NOT NULL,
    "publication_initial_sync_completed_at" timestamp with time zone,
    CONSTRAINT "pricing_property_settings_default_min_stay_check" CHECK (("default_min_stay" >= 1)),
    CONSTRAINT "pricing_property_settings_mode_check" CHECK (("mode" = ANY (ARRAY['shadow'::"text", 'apply'::"text"]))),
    CONSTRAINT "pricing_property_settings_weekly_decay_max_steps_check" CHECK (("weekly_decay_max_steps" >= 0))
);


ALTER TABLE "public"."pricing_property_settings" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pricing_publication_actions" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "property_id" "uuid" NOT NULL,
    "date" "date" NOT NULL,
    "action_type" "text" NOT NULL,
    ...
    "effective_price_before" numeric(10,2),
    "effective_price_after" numeric(10,2),
    "validation_status" "text",
    "last_attempt_at" timestamp with time zone,
    CONSTRAINT "pricing_publication_actions_mode_check" CHECK (("mode" = ANY (ARRAY['shadow'::"text", 'apply'::"text"]))),
    CONSTRAINT "pricing_publication_actions_status_check" CHECK (("status" = ANY (ARRAY['proposed'::"text", 'applying'::"text", 'applied'::"text", 'validation_failed'::"text", 'failed'::"text", 'cancelled'::"text", 'superseded'::"text"])))
);


ALTER TABLE "public"."pricing_publication_actions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pricing_seasons" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "optimisation_curve" "jsonb",
    "protect_from_automatic_reductions" boolean DEFAULT false NOT NULL,
    "market_signal_influence_pct" numeric(6,2),
    "optimisation_mode" "text" DEFAULT 'inherit'::"text" NOT NULL,
    "optimisation_preset" "text",
    "optimisation_horizon_days" integer,
    "optimisation_max_discount_pct" numeric(6,2),
    CONSTRAINT "pricing_seasons_check" CHECK (("end_date" >= "start_date")),
    CONSTRAINT "pricing_seasons_min_stay_check" CHECK (("min_stay" >= 1))
);
...
COMMENT ON COLUMN "public"."pricing_seasons"."optimisation_mode" IS 'inherit = use property curve, custom = use season curve, none = no temporal discount';
...
CREATE TABLE IF NOT EXISTS "public"."reservation_financials" (
    ...
    "api_reference" "text",
    "referer" "text",
    "customer_paid_eur" numeric,
    "tourist_tax_eur" numeric,
    "channel_commission_eur" numeric,
    "price_total_eur" numeric,
    "invoice_total_eur" numeric,
    "adr_host_payout_eur" numeric,
...
CREATE TABLE IF NOT EXISTS "public"."reservation_messages" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "reservation_id" "uuid",
    "source_system" "text" DEFAULT 'beds24'::"text" NOT NULL,
    "source_booking_id" "text",
...
ALTER TABLE "public"."reservation_messages" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."reservation_operational_context" (
    "reservation_id" "uuid" NOT NULL,
    "lifecycle_state" "text" DEFAULT 'unknown'::"text" NOT NULL,
    "previous_reservation_id" "uuid",
    "next_reservation_id" "uuid",
    "preparation_mission_id" "uuid",
    "checkout_mission_id" "uuid",
    "latest_cleaning_report_id" "uuid",
    "latest_intervention_report_id" "uuid",
...
ALTER TABLE "public"."reservation_operational_context" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."reservations" (
    ...
    "checkin_time_text" "text",
    "checkout_time_text" "text",
    "booking_time" timestamp with time zone,
    "modified_time" timestamp with time zone,
    "cancel_time" timestamp with time zone,
    "raw_payload" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "synced_at" timestamp with time zone,
    "public_token" "text",
    "cleaner_preparation_note" "text",
    "cleaner_preparation_note_updated_at" timestamp with time zone,
    "cleaner_preparation_note_updated_by" "text"
);
...
ALTER TABLE ONLY "public"."owner_insight_messages"
    ADD CONSTRAINT "owner_insight_messages_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."pricing_actions"
    ADD CONSTRAINT "pricing_actions_listing_id_date_run_id_key" UNIQUE ("listing_id", "date", "run_id");
...
ALTER TABLE ONLY "public"."pricing_autopilot_config"
    ADD CONSTRAINT "pricing_autopilot_config_pkey" PRIMARY KEY ("listing_id");



ALTER TABLE ONLY "public"."pricing_calendar_versions"
    ADD CONSTRAINT "pricing_calendar_versions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pricing_configuration_versions"
    ADD CONSTRAINT "pricing_configuration_versions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pricing_configuration_versions"
    ADD CONSTRAINT "pricing_configuration_versions_property_id_version_number_key" UNIQUE ("property_id", "version_number");



ALTER TABLE ONLY "public"."pricing_daily_prices"
    ADD CONSTRAINT "pricing_daily_prices_pkey" PRIMARY KEY ("property_id", "date");



ALTER TABLE ONLY "public"."pricing_date_overrides"
    ADD CONSTRAINT "pricing_date_overrides_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pricing_floor_rules"
    ADD CONSTRAINT "pricing_floor_rules_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pricing_property_settings"
    ADD CONSTRAINT "pricing_property_settings_pkey" PRIMARY KEY ("property_id");



ALTER TABLE ONLY "public"."pricing_publication_actions"
    ADD CONSTRAINT "pricing_publication_actions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."reservation_messages"
    ADD CONSTRAINT "reservation_messages_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_pkey" PRIMARY KEY ("reservation_id");
...
CREATE INDEX "cleaning_requests_owner_note_idx" ON "public"."cleaning_requests" USING "btree" ("id") WHERE (("owner_note" IS NOT NULL) OR ("cleaner_priority_note" IS NOT NULL));



CREATE INDEX "cleaning_requests_prepares_reservation_idx" ON "public"."cleaning_requests" USING "btree" ("prepares_reservation_id") WHERE ("prepares_reservation_id" IS NOT NULL);
...
CREATE INDEX "idx_pricing_actions_listing_date" ON "public"."pricing_actions" USING "btree" ("listing_id", "date");



CREATE INDEX "idx_pricing_actions_status" ON "public"."pricing_actions" USING "btree" ("status", "created_at" DESC);



CREATE INDEX "idx_pricing_floor_rules_listing_dates" ON "public"."pricing_floor_rules" USING "btree" ("listing_id", "start_date", "end_date") WHERE ("active" IS TRUE);
...
CREATE UNIQUE INDEX "owner_insight_messages_message_key_uidx" ON "public"."owner_insight_messages" USING "btree" ("message_key");



CREATE INDEX "owner_insight_messages_owner_active_idx" ON "public"."owner_insight_messages" USING "btree" ("owner_id", "status", "priority", "valid_from" DESC);



CREATE INDEX "owner_insight_messages_property_idx" ON "public"."owner_insight_messages" USING "btree" ("property_id", "status", "priority");



CREATE INDEX "owner_insight_messages_reservation_idx" ON "public"."owner_insight_messages" USING "btree" ("reservation_id", "status", "priority");
...
CREATE UNIQUE INDEX "pricing_calendar_versions_one_active" ON "public"."pricing_calendar_versions" USING "btree" ("property_id") WHERE ("status" = 'active'::"text");



CREATE UNIQUE INDEX "pricing_configuration_versions_one_active" ON "public"."pricing_configuration_versions" USING "btree" ("property_id") WHERE ("status" = 'active'::"text");



CREATE INDEX "pricing_daily_prices_calendar_version_idx" ON "public"."pricing_daily_prices" USING "btree" ("calendar_version_id");



CREATE INDEX "pricing_daily_prices_date_idx" ON "public"."pricing_daily_prices" USING "btree" ("date");



CREATE INDEX "pricing_daily_prices_pending_idx" ON "public"."pricing_daily_prices" USING "btree" ("property_id", "date") WHERE ("publication_status" = ANY (ARRAY['pending'::"text", 'failed'::"text"]));



CREATE UNIQUE INDEX "pricing_publication_actions_open_unique" ON "public"."pricing_publication_actions" USING "btree" ("property_id", "date", "action_type") WHERE ("status" = ANY (ARRAY['proposed'::"text", 'applying'::"text"]));



CREATE INDEX "pricing_publication_actions_retry_idx" ON "public"."pricing_publication_actions" USING "btree" ("status", "next_attempt_at", "created_at") WHERE ("status" = ANY (ARRAY['proposed'::"text", 'failed'::"text"]));



CREATE INDEX "pricing_seasons_property_dates_idx" ON "public"."pricing_seasons" USING "btree" ("property_id", "start_date", "end_date") WHERE "active";
...
CREATE INDEX "reservation_financials_checkin_idx" ON "public"."reservation_financials" USING "btree" ("checkin_date");



CREATE INDEX "reservation_financials_source_room_idx" ON "public"."reservation_financials" USING "btree" ("source_system", "source_room_id");



CREATE INDEX "reservation_messages_reservation_sent_idx" ON "public"."reservation_messages" USING "btree" ("reservation_id", "sent_at" DESC);



CREATE INDEX "reservation_messages_source_booking_idx" ON "public"."reservation_messages" USING "btree" ("source_system", "source_booking_id");



CREATE UNIQUE INDEX "reservation_messages_source_message_uidx" ON "public"."reservation_messages" USING "btree" ("source_system", "source_message_id");



CREATE INDEX "reservation_operational_context_checkout_mission_idx" ON "public"."reservation_operational_context" USING "btree" ("checkout_mission_id");



CREATE INDEX "reservation_operational_context_lifecycle_idx" ON "public"."reservation_operational_context" USING "btree" ("lifecycle_state", "risk_level");



CREATE INDEX "reservation_operational_context_preparation_mission_idx" ON "public"."reservation_operational_context" USING "btree" ("preparation_mission_id");



CREATE INDEX "reservations_cleaner_preparation_note_idx" ON "public"."reservations" USING "btree" ("id") WHERE ("cleaner_preparation_note" IS NOT NULL);



CREATE INDEX "reservations_property_dates_idx" ON "public"."reservations" USING "btree" ("property_id", "checkin_at", "checkout_at");



CREATE UNIQUE INDEX "reservations_public_token_idx" ON "public"."reservations" USING "btree" ("public_token") WHERE ("public_token" IS NOT NULL);



CREATE INDEX "reservations_source_booking_idx" ON "public"."reservations" USING "btree" ("source_system", "source_booking_id");



CREATE INDEX "reservations_source_room_dates_idx" ON "public"."reservations" USING "btree" ("source_system", "source_room_id", "checkin_at", "checkout_at");
...
CREATE OR REPLACE TRIGGER "owner_insight_messages_set_updated_at" BEFORE UPDATE ON "public"."owner_insight_messages" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "reservation_messages_set_updated_at" BEFORE UPDATE ON "public"."reservation_messages" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "reservation_operational_context_set_updated_at" BEFORE UPDATE ON "public"."reservation_operational_context" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
ALTER TABLE ONLY "public"."cleaning_requests"
    ADD CONSTRAINT "cleaning_requests_prepares_reservation_id_fkey" FOREIGN KEY ("prepares_reservation_id") REFERENCES "public"."reservations"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."owner_insight_messages"
    ADD CONSTRAINT "owner_insight_messages_cleaning_report_id_fkey" FOREIGN KEY ("cleaning_report_id") REFERENCES "public"."cleaning_reports"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_insight_messages"
    ADD CONSTRAINT "owner_insight_messages_cleaning_request_id_fkey" FOREIGN KEY ("cleaning_request_id") REFERENCES "public"."cleaning_requests"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_insight_messages"
    ADD CONSTRAINT "owner_insight_messages_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."owners"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_insight_messages"
    ADD CONSTRAINT "owner_insight_messages_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_insight_messages"
    ADD CONSTRAINT "owner_insight_messages_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_calendar_versions"
    ADD CONSTRAINT "pricing_calendar_versions_configuration_version_id_fkey" FOREIGN KEY ("configuration_version_id") REFERENCES "public"."pricing_configuration_versions"("id");



ALTER TABLE ONLY "public"."pricing_calendar_versions"
    ADD CONSTRAINT "pricing_calendar_versions_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_configuration_versions"
    ADD CONSTRAINT "pricing_configuration_versions_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_configuration_versions"
    ADD CONSTRAINT "pricing_configuration_versions_rolled_back_from_version_id_fkey" FOREIGN KEY ("rolled_back_from_version_id") REFERENCES "public"."pricing_configuration_versions"("id");



ALTER TABLE ONLY "public"."pricing_daily_prices"
    ADD CONSTRAINT "pricing_daily_prices_calendar_version_id_fkey" FOREIGN KEY ("calendar_version_id") REFERENCES "public"."pricing_calendar_versions"("id");



ALTER TABLE ONLY "public"."pricing_daily_prices"
    ADD CONSTRAINT "pricing_daily_prices_configuration_version_id_fkey" FOREIGN KEY ("configuration_version_id") REFERENCES "public"."pricing_configuration_versions"("id");



ALTER TABLE ONLY "public"."pricing_daily_prices"
    ADD CONSTRAINT "pricing_daily_prices_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_daily_prices"
    ADD CONSTRAINT "pricing_daily_prices_source_season_id_fkey" FOREIGN KEY ("source_season_id") REFERENCES "public"."pricing_seasons"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."pricing_date_overrides"
    ADD CONSTRAINT "pricing_date_overrides_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_property_settings"
    ADD CONSTRAINT "pricing_property_settings_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_publication_actions"
    ADD CONSTRAINT "pricing_publication_actions_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pricing_seasons"
    ADD CONSTRAINT "pricing_seasons_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."reservation_messages"
    ADD CONSTRAINT "reservation_messages_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_conte_latest_intervention_report_i_fkey" FOREIGN KEY ("latest_intervention_report_id") REFERENCES "public"."intervention_reports"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_checkout_mission_id_fkey" FOREIGN KEY ("checkout_mission_id") REFERENCES "public"."cleaning_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_latest_cleaning_report_id_fkey" FOREIGN KEY ("latest_cleaning_report_id") REFERENCES "public"."cleaning_reports"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_next_reservation_id_fkey" FOREIGN KEY ("next_reservation_id") REFERENCES "public"."reservations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_preparation_mission_id_fkey" FOREIGN KEY ("preparation_mission_id") REFERENCES "public"."cleaning_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_previous_reservation_id_fkey" FOREIGN KEY ("previous_reservation_id") REFERENCES "public"."reservations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reservation_operational_context"
    ADD CONSTRAINT "reservation_operational_context_reservation_id_fkey" FOREIGN KEY ("reservation_id") REFERENCES "public"."reservations"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."owner_insight_messages" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."pricing_autopilot_config" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."pricing_calendar_versions" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."pricing_configuration_versions" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."pricing_floor_rules" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."pricing_property_settings" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."pricing_publication_actions" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."reservation_operational_context" ENABLE ROW LEVEL SECURITY;
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_current_alerts" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_current_alerts" TO "authenticated";
GRANT ALL ON TABLE "public"."ops_current_alerts" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_health_summary" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_health_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."ops_health_summary" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_recent_activity" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_recent_activity" TO "authenticated";
GRANT ALL ON TABLE "public"."ops_recent_activity" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_script_health" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."ops_script_health" TO "authenticated";
GRANT ALL ON TABLE "public"."ops_script_health" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."owner_insight_messages" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."owner_insight_messages" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_insight_messages" TO "service_role";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_actions" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_actions" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_actions" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_autopilot_config" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_autopilot_config" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_autopilot_config" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_calendar_versions" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_calendar_versions" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_calendar_versions" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_configuration_versions" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_configuration_versions" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_configuration_versions" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_daily_prices" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_daily_prices" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_daily_prices" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_date_overrides" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_date_overrides" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_date_overrides" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_floor_rules" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_floor_rules" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_floor_rules" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_property_settings" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_property_settings" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_property_settings" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_publication_actions" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_publication_actions" TO "authenticated";
GRANT ALL ON TABLE "public"."pricing_publication_actions" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_seasons" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pricing_seasons" TO "authenticated";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."reservation_messages" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."reservation_messages" TO "authenticated";
GRANT ALL ON TABLE "public"."reservation_messages" TO "service_role";



GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."reservation_operational_context" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."reservation_operational_context" TO "authenticated";
GRANT ALL ON TABLE "public"."reservation_operational_context" TO "service_role";
