...
The property defines the expected work.

The cleaner defines the cost of performing that work.

Mission compensation is calculated automatically from:
...
Different cleaners may therefore receive different offers
