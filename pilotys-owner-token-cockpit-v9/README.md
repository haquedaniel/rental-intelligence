# Pilotys owner cockpit v9

This package fixes the v8 placement mistake.

The deployed Next.js app is `apps/cleaner-web`, so v9 installs the token owner cockpit into:
...
```bash
bash /path/to/pilotys-owner-token-cockpit-v9/scripts/install-v9-cleaner-web.sh
