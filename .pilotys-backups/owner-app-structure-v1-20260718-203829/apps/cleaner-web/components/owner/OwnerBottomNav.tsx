...
function itemsFor(pathname: string | null): NavItem[] {
  ...
  return [
    { key: "cockpit", label: "Cockpit", short: "Cockpit", href: cockpit, icon: "✦" },
...
export function OwnerTopNav({ active }: { active?: OwnerNavActive }) {
  ...
  return (
    <nav className="flex items-center justify-between gap-3">
      ...
      >
        <span className="relative grid h-9 w-9 place-items-center rounded-2xl bg-[#112532] text-sm font-black text-white shadow-sm">
          P
          <span className="absolute right-1 top-1 h-2.5 w-2.5 rounded-full bg-[#E0680E]" />
        </span>
