...
BACKUP_DIR="$ROOT/.pilotys-backups/beds24-messages-v1-$STAMP"
...
echo "Installed Beds24 reservation messages v1"
echo "Backup: $BACKUP_DIR"
echo ""
echo "Suggested test commands:"
echo "  python scripts/discover_beds24_messages.py --limit 3"
echo "  python scripts/sync_cleaning_reservations.py"
echo "  python scripts/sync_reservation_financials.py"
echo "  python scripts/sync_beds24_reservation_messages.py --limit 3 --dry-run"
